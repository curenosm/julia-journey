...
# ╔═╡ 383a57ae-457e-11ef-2139-fbdab2fd90e5
begin
  using StaticArrays
  using WaterLily
  using Metal
...
# ╔═╡ 93faf652-6611-4cd3-a793-4d2c61de58ea
begin
  using GLMakie
  using Meshing
  using GeometryBasics

  function makie_video(makie_plot, sim, dat, obs_update!; remeasure = false, file = "")
...
# ╔═╡ a4c8a5e4-ff3e-4aee-89e1-463d9576a757
begin
  colormap = :viridis |> to_colormap |> reverse
  norm(x::StaticArray) = √(x' * x)

  function makie_simulation(; n = 2^6, U = 1, Re = 1000, mem = Array)
    R = n / 2
    function sdf(xyz, t) # signed distance function
      norm(xyz) - R
    end
    map(xyz, t) = xyz - SA[2n/3, 0, 0] # Move the center
    Simulation((2n, n, n), (U, 0, 0), R; ν = U * R / Re, body = AutoBody(sdf, map), mem)
  end
end

# ╔═╡ 8c128bea-4477-4b1a-ba1b-f063176b1ae1
sim = makie_simulation()

# ╔═╡ d03232d4-82c0-439a-9c51-c3f6b804cbc5
sim_step!(sim, 0.2)

# ╔═╡ 0ff5133d-132a-480d-ac3a-8e51f3415a47
begin
...
manifest_format = "2.0"
project_hash = "d00984c02a2f4dc72c91ac1ea571bfcdaf951e58"
...
git-tree-sha1 = "770eadb474b5cbd0c468a9078eec864d59701b2e"
...
[[deps.Metal]]
deps = ["Adapt", "Artifacts", "CEnum", "CodecBzip2", "ExprTools", "GPUArrays", "GPUCompiler", "KernelAbstractions", "LLVM", "LLVMDowngrader_jll", "LinearAlgebra", "ObjectFile", "ObjectiveC", "PrecompileTools", "Preferences", "Printf", "Python_jll", "Random", "Reexport", "Requires", "SHA", "StaticArrays", "UUIDs"]
...
git-tree-sha1 = "365d785af4c53b1eec62cfdf5379797278b2f7ca"
...
[[deps.WaterLily]]
deps = ["EllipsisNotation", "ForwardDiff", "KernelAbstractions", "LinearAlgebra", "Printf", "Reexport", "Requires", "StaticArrays", "TOML"]
git-tree-sha1 = "a11c808b55dcd1af636198cd80272029505fcea5"
uuid = "ed894a53-35f9-47f1-b17f-85db9237eebd"
version = "1.0.4"

    [deps.WaterLily.extensions]
    WaterLilyAMDGPUExt = "AMDGPU"
    WaterLilyCUDAExt = "CUDA"
    WaterLilyReadVTKExt = "ReadVTK"
    WaterLilyWriteVTKExt = "WriteVTK"

    [deps.WaterLily.weakdeps]
